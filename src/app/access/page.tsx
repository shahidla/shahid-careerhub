    ...
    <main className="min-h-screen bg-white flex items-center justify-center px-6">
      <div className="w-full max-w-sm space-y-5">
        <div className="text-center">
          <p className="text-xs font-semibold text-text-subtle uppercase tracking-widest mb-2">Protected Access</p>
          <h1 className="text-2xl font-bold text-text">AI Career Hub</h1>
