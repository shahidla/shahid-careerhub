...
INSERT INTO skills (category, items, is_ai, sort_order) VALUES
  ...
  ('AI (Exploration)', ARRAY['Machine learning and AI-based workflows (proof-of-concept)','SAP HANA PAL and R-based modelling','AI-assisted automation patterns'], true, 4),
