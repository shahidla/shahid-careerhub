...
VALUES (
  ...
  ARRAY['Reduced S/4HANA data scrambling runtime from 240 hours to 6 hours','Processed more than 40 billion records in SAP CAR UDF high-volume developments','Granted patent US10304013B2','SAP Community contributor, blogger, TechEd speaker, and hackathon winner']
);
