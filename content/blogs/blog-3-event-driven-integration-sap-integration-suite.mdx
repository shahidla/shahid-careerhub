...
- [A comprehensive guide to using the JDBC adapter in SAP Integration Suite](https://community.sap.com/t5/technology-blog-posts-by-members/a-comprehensive-guide-to-using-the-jdbc-adapter-in-sap-integration-suite/ba-p/13903154)
