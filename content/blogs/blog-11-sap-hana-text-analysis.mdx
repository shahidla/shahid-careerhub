...
![Screenshot 1](/blogs/blog-11-sap-hana-text-analysis/image-1.jpg)
...
![Screenshot 2](/blogs/blog-11-sap-hana-text-analysis/image-2.jpg)

    2. Table to fetch the data. Maintain some sample records. In this case **"amohas97.session.data::srnum"**

![Screenshot 3](/blogs/blog-11-sap-hana-text-analysis/image-3.jpg)
...
![Screenshot 4](/blogs/blog-11-sap-hana-text-analysis/image-4.jpg)
...
![Screenshot 5](/blogs/blog-11-sap-hana-text-analysis/image-5.jpg)

**1.      Now run the procedure again, this time the procedure will return the data with 4 columns**

![Screenshot 6](/blogs/blog-11-sap-hana-text-analysis/image-6.jpg)
